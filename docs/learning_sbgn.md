...
<p>The diagram can be redrawn in any application that supports the required shapes, for example, in PowerPoint, InkScape, Adobe Illustrator. For that you can use the available <a href="/sbgn/templates">templates</a>.</p>
