...
<p>This section is based on the recently published educational paper by Toure and coauthors *Quick tips for creating effective and impactful biological pathways using the Systems Biology Graphical Notation* (Toure et al., 2018, <a href="https://dx.doi.org/10.1371/journal.pcbi.1005740">doi:10.1371/journal.pcbi.1005740</a>).</p>
